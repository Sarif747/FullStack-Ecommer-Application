...
import com.fullstack.springbootecommerce.service.CheckoutService;
...
public class CheckoutController {
    ...
    public ResponseEntity<String> createPayementIntent(@RequestBody PaymentInfo paymentInfo) throws StripeException{
